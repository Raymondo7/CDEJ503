...
@section('admin-content')
            ...
            <section class="content">
                <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="4" style="resize: none; text-transform: uppercase;"
                                            placeholder="Entrez le titre ici ..." name="titre">{{ $post->titre }}</textarea>
                                    </div>
                                    @if ($errors->has('titre'))
                                ...
                                <div class="col-md-4">
                                    <div class="img w-100 border border-1 border-secondary text-center d-flex justify-content-center align-items-center"
                                        ...
                                        <span><img class="p-3" style="max-width: 100%; height:300px;"
                                                src="{{ asset('storage/' . $post->photo) }}" alt="image"></span>
                                    </div>
                                </div>
                                <!-- /.col -->
                            </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-success text-center px-5" id="btn-publier">
    ...
    < @endsection @section('autre-js') <script>
        $(function() {
            // Summernote
